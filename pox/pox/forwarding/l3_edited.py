# Appendix D: Initialization of L3 POX Controller

# Nhung dong lenh danh dau ###### la co chinh sua so voi file goc
...
class l3_switch (EventMixin):
  ...
  def _handle_openflow_PacketIn (self, event):
        ...
        for k,v in diction.items():
          ...
          for i,j in v.items():
            ...
            if j >= 5:
              ...
              # Tinh toan response time

              end = time.time()	######	

              resp_time = end - resp_obj.startMarker()	######
    ...
    if isinstance(packet.next, ipv4):
      ...
      # Thu thap gia tri entropy tinh duoc (ent_obj lay tu file detectionUsingEntropy.py)
      ...
      if ent_obj.value < dynamicThres:	######
        ...
        print('Suspected Alarm - Using SVM Model Prediction')
        print('\n')
        print(ent_obj.value)
